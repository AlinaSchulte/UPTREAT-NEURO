...
uicontrol('Style','edit','units','normalized','pos',[.1 .8 .25 .1],'String','SOUND DEMO','fontsize',15,'Callback',@idText_Callback);

uicontrol('Style','text','units','normalized','pos',[.1 .63 .25 .1],'String','Demos:','fontsize',10,'BackgroundColor',bgcol,'HorizontalAlignment','left');
...
uicontrol('Style','pushbutton','units','normalized','pos',[.4 .8 .25 .1],'fontsize',14,'String','RUN DEMO','Callback',@runbutton_Callback);
