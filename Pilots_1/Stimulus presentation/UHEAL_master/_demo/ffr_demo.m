...
reps = 1;
conds = [];
conds = 1%repmat([1:2],1,reps);
%conds = Shuffle(conds);
Nperiods = 10; % periods per trial x 6 stims
...
stim = {};
stim.fc = 326%[repmat(326,1,2)];
stim.polarity = 1%[repmat([1,-1],1)];
stim.noise = 0%[repmat([0 0],1,1)];
stim.modf = 4%repmat(4,1,2);
stim.ear = dat.ear%repmat(dat.ear,1,2);
stim.targetlevel = 85%repmat(85,1,2);
