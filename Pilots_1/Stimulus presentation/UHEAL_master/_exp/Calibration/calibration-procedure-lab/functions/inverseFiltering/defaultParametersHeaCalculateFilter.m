...
mag.highDropFreq = 17000; % upper roll-off frequency (above this frequency the spectrum will be set constant)
...
lsq.highDropFreq = 20000; % lower roll-off frequency (below this frequency the spectrum will be set constant)
