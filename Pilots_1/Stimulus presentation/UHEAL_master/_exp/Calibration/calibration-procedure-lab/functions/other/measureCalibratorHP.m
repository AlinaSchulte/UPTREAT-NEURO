function measuredRMSMic = measureCalibratorHP(audioFunc,fs,channelRec,...
    durationCalibrator)
...
waitfor(hWarn);
hWarn = warndlg('Place calibrator on the headphone coupler and check that meter reading is 93.8 dB SPL','PLACE CALIBRATOR');
waitfor(hWarn);
