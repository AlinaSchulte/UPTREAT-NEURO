function AEP_EFR_main_short_long(dat)
clc
addpath(genpath(pwd))
...
%% Experimental part
% choose ear
if dat.ear == 1 % left ear
    stim_y = [this_stim(1,:);zeros(size(this_stim(2,:)))]';
elseif dat.ear ==2 % right ear
    stim_y = [zeros(size(this_stim(1,:)));this_stim(2,:)]';
end
%add trigger here
trig_y = this_trig';
fs = stim.fs;
